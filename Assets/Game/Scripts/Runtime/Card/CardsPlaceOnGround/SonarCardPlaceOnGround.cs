...
namespace Game
{
    [CreateAssetMenu(fileName = "SonarCardPlaceOnGround", menuName = "Cards/Place On Ground/Sonar Card Place On Ground")]
    public class SonarCardPlaceOnGround : SupportCardPlaceOnGround
    {
