...
namespace Game
{
    public class BattleCard : BaseCard, IDragHandler, IBeginDragHandler, IEndDragHandler, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public override void OnBeginDrag(PointerEventData eventData)
        {
           ...
           /* List<RaycastResult> raycastResults = RayCastUtilities.GetPointerRaycasterResult(eventData);
            ...
            lastCardInteractable.OnBeginDragWithCard(this);
        } 
