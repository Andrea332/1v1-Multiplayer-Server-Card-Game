...
namespace Game
{
    public class ServerAmmunitionAbility : ServerAbilityManager
    {
        private CardData MainCardData { get; }
        private int AttackToAdd { get; }
        private int MainCardDamageBeforeDestroying { get; }
        
        public ServerAmmunitionAbility(CardBattleBoardManager cardBattleBoardManager, CardData cardDataUsed, CardData mainCardData, int attackToAdd, int mainCardDamageBeforeDestroying) : base(cardBattleBoardManager, cardDataUsed)
        {
