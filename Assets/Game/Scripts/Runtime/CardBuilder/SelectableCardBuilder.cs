...
namespace Game
{
    [CreateAssetMenu(fileName = "SelectableCardBuilder", menuName = "Card Builders/SelectableCardBuilder")]
    public class SelectableCardBuilder : BaseCardBuilder
    {
        ...
        public override BaseCard BuildCardWithReturnType(BaseCard card, NetworkedCardData cardData, bool sendEvent = true)
        {
            ...
            card.TrySetInventoryIdComponent(cardData.cardInventoryId, card.GetComponentInChildren<CardInventoryIdPresenter>());
